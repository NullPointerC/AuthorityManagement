...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/project?useUnicode=true&&useSSL=false&&characterEncoding=utf8&&serverTimezone=Asia/Shanghai");
        ...
        if(scanner("是否继承基类").equalsIgnoreCase("y")) {
            strategy.setSuperEntityClass("cn.homyit.accessadmin.entity.BaseEntity");
